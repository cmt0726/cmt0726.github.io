...
tweet_dic = {"BORDER": "FUN PLACE", "WALL": "FUN ZONE", "Fake": "SUPER DUPER TRUE", "funny": "MEGA LOL",
             ...
             'portray': 'tickle', 'Enemy': 'Pizza Delivery Man :)', 'me': 'ME', 'Iran': 'Meat', 'Roger': 'Roger, Hard as a Rock,', '...': '', 'we': 'WE', 'MAKE AMERICA GREAT AGAIN!': 'I LIKE ROCKS'}
...
def tweet():
    with open('C:/Users/Connor/PycharmProjects/LawnMower/twitter/realdonaldtrump_tweets.csv', newline='') as csv_file:
